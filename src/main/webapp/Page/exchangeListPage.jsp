    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <!--가로-->
          <picture>
            <source srcset="./img/banner1-exchange.png" media="(min-width: 768px)" />
            <source srcset="./img/banner1(mini)-exchange.png" media="(min-width:370px)" />
            <img src="./img/banner1-exchange.png">
        </picture>
        ...
        <div class="carousel-item">
          <picture>
            <source srcset="./img/banner2-exchange.png" media="(min-width: 768px)" />
            <source srcset="./img/banner2(mini)-exchange.png" media="(min-width:370px)" />
            <img src="./img/banner2-exchange.png">
        </picture>
        </div>
        <div class="carousel-item">
          <picture>
            <source srcset="./img/banner3-exchange.png" media="(min-width: 768px)" />
            <source srcset="./img/banner3(mini)-exchange.png" media="(min-width:370px)" />
            <img src="./img/banner3-exchange.png">
        </picture>
        </div>
