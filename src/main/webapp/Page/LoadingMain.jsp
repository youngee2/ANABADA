...
<head>
  ...
  <script src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/ScrollToPlugin3.min.js">
  </script>
  ...
  <style>
    ...
    body,
    html {
        cursor: url("https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FxKys9%2FbtrNOTLRm4B%2FGuodC2Nj4iuqBo8s8jfgy1%2Fimg.png"), auto;
...
<body>
  ...
  <svg class="container" width="100%" height="100%">
    <defs>
      <mask id="m"></mask>
      <g id="titleANABADA">
        <text class="titleANABADA" x="5%" y="5%" fill="#162a43" letter-spacing="0.15">ANABADA</text>
      </g>

      <g id="subtitle">
        <rect width="750" height="120" text-anchor="middle" alignment-baseline="middle" fill="none" />
        <text class="subtitle" text-anchor="middle" alignment-baseline="middle" fill="#fff">Our Choice for Global
          Warming</text>
      </g>
    </defs>

    <use xlink:href="#subtitle" x="50%" y="50%" transform="translate(-375 0)" />

    <g mask="url(#m)">
      <rect fill="#fff" width="100%" height="100%" />
      <use xlink:href="#titleANABADA" x="45%" y="50%" transform="translate(-375 0)" />
    </g>
  ...
  <svg class="start" viewBox="0 0 300 150">
    <g>
      <a href="/z_webproject/Metaverse.html">
